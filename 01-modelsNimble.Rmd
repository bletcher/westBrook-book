...
load('./models/dataOut/eh_2002200320042005200620072008200920102011201220132014_wb obear.RData')
```
...
save(mcmc.phi_p, file = paste0('./models/runsOut/mcmc_phi_p_', substr(end,1,13), '.RData'))
...
save(mcmc.phiT_pT, file = paste0('./models/runsOut/mcmc_phiT_pT_', substr(end,1,13), '.RData'))
...
save(mcmc.phiT_pT_cohort, file = paste0('./models/runsOut/mcmc_phiT_pT_cohort_', substr(end,1,13), '.RData'))
...
save(mcmc.phiT_pT_cohort_flow, file = paste0('./models/runsOut/mcmc_phiT_pT_cohort_flow_', substr(end,1,13), '.RData'))
