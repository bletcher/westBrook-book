...
if (rerunSurivalModels) {
  ...
  toSave <- list(
    ...
    elapsed = elapsed_phi_p_flowCohort, 
    myConstants = myConstants, 
    nIter = nIter, 
    nBurnin = nBurnin,
    thinRate = thinRate, 
...
if(plotMCMCOutput) {
  ...
  MCMCsummary(object = mcmc.phiT_pT_cohort_flow, round = 2)
  #MCMCplot(object = mcmc.phiT_pT_cohort_flow, params = "betaPhiOut")
  MCMCplot(object = mcmc_phiT_pT_cohort_flowCohort, params = "betaFlow")# 
  MCMCplot(object = mcmc_phiT_pT_cohort_flowCohort, params = c("betaPhiCohortOut"))
  MCMCplot(object = mcmc_phiT_pT_cohort_flowCohort, params = c("betaPCohortOut"))
  
  priors <- runif(nIter * nChains, 0, 1)
  MCMCtrace(object = mcmc_phiT_pT_cohort_flowCohort,
            #ISB = FALSE,
            #exact = TRUE, 
            params = c("betaPhiCohortOut"),
            pdf = FALSE, 
