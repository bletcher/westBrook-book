...
Use `bookdown::render_book()` to render the book (not showing up in the 'Build' tab like the bookdown book (https://bookdown.org/yihui/bookdown/usage.html) says it should. Use `bookdown::render_book("index.Rmd", "bookdown::gitbook")` to force html book.  
