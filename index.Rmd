...
Use `bookdown::render_book("index.Rmd", "bookdown::gitbook")` to force html book. `bookdown::preview_chapter("01-modelsCMR_Flow.Rmd", "bookdown::gitbook")` to update just one chapter (01-modelsYOY.Rmd as example here). 
