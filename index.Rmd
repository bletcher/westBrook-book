...
Use `bookdown::render_book("index.Rmd", "bookdown::gitbook")` to force html book. `bookdown::preview_chapter("index.Rmd", "bookdown::gitbook")` to update just one chapter (index.Rmd as example here). 

Use `clean_book()` to clean up temporary files.

Before rendering, seem to need to restart R session to avoid an error with all_of()
