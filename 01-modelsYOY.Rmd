...
#### Flow and temperature correlations for means
```{r}
...
#### Flow and temperature from previous *one* month
```{r means1Month}
...
#save(means, modLMMeans2, file = "models/modLMMeans2.Rdata")
```

#### Flow and temperature from previous *three* months
```{r means3Month}
...
#### Flow and temperature from previous *five* months
```{r means5Month}
